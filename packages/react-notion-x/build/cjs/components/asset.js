...
var Asset = function (_a) {
    ...
    var _k = (0, context_1.useNotionContext)(), recordMap = _k.recordMap, mapImageUrl = _k.mapImageUrl, components = _k.components;
    ...
    if (block.type === 'tweet') {
        ...
        var caption = (0, notion_utils_1.getTextContent)((_j = block.properties) === null || _j === void 0 ? void 0 : _j.caption);
        var alt = caption || 'notion image';
        content = (react_1["default"].createElement(lazy_image_1.LazyImage, { src: src, alt: alt, style: assetStyle, zoomable: false, height: style.height }));
    }
