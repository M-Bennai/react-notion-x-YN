...
var Block = function (props) {
    ...
    var blockId = hideBlockId
        ? 'notion-block'
        : "notion-block-" + (0, notion_utils_1.uuidToId)(block.id);
    switch (block.type) {
        ...
        case 'page':
            if (level === 0) {
                ...
                if (fullPage) {
                    ...
                    var pageIcon = (_c = (0, notion_utils_1.getBlockIcon)(block, recordMap)) !== null && _c !== void 0 ? _c : defaultPageIcon;
                    var isPageIconUrl = pageIcon && (0, utils_1.isUrl)(pageIcon);
                    var toc = (0, notion_utils_1.getPageTableOfContents)(block, recordMap);
                    ...
                    var actionSectionScrollSpy_1 = (0, lodash_throttle_1["default"])(function () {
                    ...
                    return (react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion', 'notion-app', darkMode ? 'dark-mode' : 'light-mode', blockId, className) },
                        ...
                        react_1["default"].createElement("div", { className: 'notion-frame' },
                            ...
                            react_1["default"].createElement("div", { className: 'notion-page-scroller' },
                                hasPageCover ? (pageCover ? (pageCover) : (react_1["default"].createElement(lazy_image_1.LazyImage, { src: mapImageUrl(page_cover, block), alt: (0, notion_utils_1.getTextContent)(properties_1 === null || properties_1 === void 0 ? void 0 : properties_1.title), className: 'notion-page-cover', style: {
                                        objectPosition: "center " + coverPosition + "%"
                                    } }))) : null,
                                react_1["default"].createElement("main", { className: (0, utils_1.cs)('notion-page', hasPageCover
                                    ...
                                    react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion-page-content', hasAside && 'notion-page-content-has-aside', hasToc && 'notion-page-content-has-toc') },
                                        ...
                                        hasAside && (react_1["default"].createElement("aside", { className: 'notion-aside' },
                                            hasToc && (react_1["default"].createElement("div", { className: 'notion-aside-table-of-contents' },
                                                ...
                                                react_1["default"].createElement("nav", { className: (0, utils_1.cs)('notion-table-of-contents', !darkMode && 'notion-gray') }, toc.map(function (tocItem) {
                                                    var id = (0, notion_utils_1.uuidToId)(tocItem.id);
                                                    return (react_1["default"].createElement("a", { key: id, href: "#" + id, className: (0, utils_1.cs)('notion-table-of-contents-item', "notion-table-of-contents-item-indent-level-" + tocItem.indentLevel, activeSection_1 === id &&
                    ...
                    return (react_1["default"].createElement("main", { className: (0, utils_1.cs)('notion', darkMode ? 'dark-mode' : 'light-mode', 'notion-page', page_full_width && 'notion-full-width', page_small_text && 'notion-small-text', blockId, className, bodyClassName) },
                        react_1["default"].createElement("div", { className: 'notion-viewport' }),
                        pageHeader,
                ...
                return (react_1["default"].createElement(components.pageLink, { className: (0, utils_1.cs)('notion-page-link', blockColor_1 && "notion-" + blockColor_1, blockId), href: mapPageUrl(block.id) },
        ...
        case 'sub_sub_header': {
            ...
            var id = (0, notion_utils_1.uuidToId)(block.id);
            var title_1 = (0, notion_utils_1.getTextContent)(block.properties.title) || "Notion Header " + id;
            ...
            if (indentLevel === undefined) {
                var page = (0, notion_utils_1.getBlockParentPage)(block, recordMap);
                if (page) {
                    var toc = (0, notion_utils_1.getPageTableOfContents)(page, recordMap);
            ...
            var classNameStr = (0, utils_1.cs)(isH1 && 'notion-h notion-h1', isH2 && 'notion-h notion-h2', isH3 && 'notion-h notion-h3', blockColor_2 && "notion-" + blockColor_2, indentLevelClass, blockId);
        ...
        case 'divider':
            return react_1["default"].createElement("hr", { className: (0, utils_1.cs)('notion-hr', blockId) });
        case 'text':
            if (!block.properties && !((_f = block.content) === null || _f === void 0 ? void 0 : _f.length)) {
                return react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion-blank', blockId) }, "\u00A0");
            }
            var blockColor = (_g = block.format) === null || _g === void 0 ? void 0 : _g.block_color;
            return (react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion-text', blockColor && "notion-" + blockColor, blockId) },
        ...
        case 'numbered_list':
            var wrapList = function (content, start) {
                return block.type === 'bulleted_list' ? (react_1["default"].createElement("ul", { className: (0, utils_1.cs)('notion-list', 'notion-list-disc', blockId) }, content)) : (react_1["default"].createElement("ol", { start: start, className: (0, utils_1.cs)('notion-list', 'notion-list-numbered', blockId) }, content));
            };
            var output = null;
            if (block.content) {
            ...
            var start = (0, utils_1.getListNumber)(block.id, recordMap.block);
        ...
        case 'column_list':
            return react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion-row', blockId) }, children);
        case 'column':
            ...
            return (react_1["default"].createElement(react_1["default"].Fragment, null,
                react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion-column', blockId), style: style }, children),
        ...
        case 'quote': {
            ...
            return (react_1["default"].createElement("blockquote", { className: (0, utils_1.cs)('notion-quote', blockColor_3 && "notion-" + blockColor_3, blockId) },
                react_1["default"].createElement(text_1.Text, { value: block.properties.title, block: block })));
        }
        ...
        case 'callout':
            if (components.callout) {
                return react_1["default"].createElement(components.callout, { block: block, className: blockId });
            }
            else {
                return (react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion-callout', ((_s = block.format) === null || _s === void 0 ? void 0 : _s.block_color) &&
        ...
        case 'bookmark':
            if (!block.properties)
                return null;
            var title = (0, notion_utils_1.getTextContent)((_v = block.properties) === null || _v === void 0 ? void 0 : _v.title);
            if (!title) {
                title = (0, notion_utils_1.getTextContent)((_w = block.properties) === null || _w === void 0 ? void 0 : _w.link);
            }
            if (title) {
            ...
            return (react_1["default"].createElement("div", { className: 'notion-row' },
                react_1["default"].createElement(components.link, { target: '_blank', rel: 'noopener noreferrer', className: (0, utils_1.cs)('notion-bookmark', ((_x = block.format) === null || _x === void 0 ? void 0 : _x.block_color) && "notion-" + block.format.block_color, blockId), href: block.properties.link[0][0] },
                    ...
                    ((_3 = block.format) === null || _3 === void 0 ? void 0 : _3.bookmark_cover) && (react_1["default"].createElement("div", { className: 'notion-bookmark-image' },
                        react_1["default"].createElement(graceful_image_1.GracefulImage, { src: (_4 = block.format) === null || _4 === void 0 ? void 0 : _4.bookmark_cover, alt: (0, notion_utils_1.getTextContent)((_5 = block.properties) === null || _5 === void 0 ? void 0 : _5.title), loading: 'lazy' }))))));
        case 'toggle':
            return (react_1["default"].createElement("details", { className: (0, utils_1.cs)('notion-toggle', blockId) },
        ...
        case 'table_of_contents': {
            ...
            return (react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion-table-of-contents', blockColor_4 && "notion-" + blockColor_4, blockId) }, toc.map(function (tocItem) { return (react_1["default"].createElement("a", { key: tocItem.id, href: "#" + (0, notion_utils_1.uuidToId)(tocItem.id), className: 'notion-table-of-contents-item' },
                react_1["default"].createElement("span", { className: 'notion-table-of-contents-item-body', style: {
                        display: 'inline-block',
        ...
        case 'to_do':
            ...
            return (react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion-to-do', blockId) },
                react_1["default"].createElement("div", { className: 'notion-to-do-item' },
                    react_1["default"].createElement(components.checkbox, { blockId: blockId, isChecked: isChecked }),
                    react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion-to-do-body', isChecked && "notion-to-do-checked") },
        ...
        case 'transclusion_container':
            return react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion-sync-block', blockId) }, children);
